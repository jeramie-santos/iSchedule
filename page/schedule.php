                ...
                <div class="form__form-parts">
                    ...
                    <div class="form-part first">
                        ...
                        <div id="dept_0" class="form__card">
                            ...
                            <span class="form__dept-title" data-dept="1" data-deptName="Ear, Nose, and Throat">ENT</span>
                        </div>
                        <div id="dept_1" class="form__card">
                            <div class="form__img-container"> 
                                <img class="form__dept-img" src="./../imgs/dummyimg.png" alt="" srcset="">
                            </div>
                            <span class="form__dept-title" data-dept="2" data-deptName="Hematology">Hematology</span>
                        </div>
                        <div id="dept_2" class="form__card">
                            <div class="form__img-container"> 
                                <img class="form__dept-img" src="./../imgs/dummyimg.png" alt="" srcset="">
                            </div>
                            <span class="form__dept-title" data-dept="3" data-deptName="Internal Medicine">Internal Medicine</span>
                        </div>
                        <div id="dept_3" class="form__card">
                            <div class="form__img-container"> 
                                <img class="form__dept-img" src="./../imgs/im_clearance.png" alt="" srcset="">
                            </div>
                            <span class="form__dept-title" data-dept="4" data-deptName="Internal Medicine Clearance">Internal Medicine Clearance</span>
                        </div>
                        <div id="dept_4" class="form__card">
                            <div class="form__img-container"> 
                                <img class="form__dept-img" src="./../imgs/dummyimg.png" alt="" srcset="">
                            </div>
                            <span class="form__dept-title" data-dept="5" data-deptName="Nephrology">Nephrology</span>
                        </div>
                        <div id="dept_5" class="form__card">
                            <div class="form__img-container"> 
                                <img class="form__dept-img" src="./../imgs/neurology.png" alt="" srcset="">
                            </div>
                            <span class="form__dept-title" data-dept="6" data-deptName="Neurology">Neurology</span>
                        </div>
                        <div id="dept_6" class="form__card">
                            <div class="form__img-container"> 
                                <img class="form__dept-img" src="./../imgs/ob_new.png" alt="" srcset="">
                            </div>
                            <span class="form__dept-title" data-dept="7" data-deptName="Obstetrics and Gynecology New">OB GYNE New</span>
                        </div>
                        <div id="dept_7" class="form__card">
                            <div class="form__img-container"> 
                                <img class="form__dept-img" src="./../imgs/ob_old.png" alt="" srcset="">
                            </div>
                            <span class="form__dept-title" data-dept="8" data-deptName="Obstetrics and Gynecology Old">OB GYNE Old</span>
                        </div>
                        <div id="dept_8" class="form__card">
                            <div class="form__img-container"> 
                                <img class="form__dept-img" src="./../imgs/ob_ros.png" alt="" srcset="">
                            </div>
                            <span class="form__dept-title" data-dept="9" data-deptName="Obstetrics and Gynecology Review of Systems">OB GYNE ROS</span>
                        </div>
                        <div id="dept_9" class="form__card">
                            <div class="form__img-container"> 
                                <img class="form__dept-img" src="./../imgs/dummyimg.png" alt="" srcset="">
                            </div>
                            <span class="form__dept-title" data-dept="10" data-deptName="Oncology">Oncology</span>
                        </div>
                        <div id="dept_10" class="form__card">
                            <div class="form__img-container"> 
                                <img class="form__dept-img" src="./../imgs/dummyimg.png" alt="" srcset="">
                            </div>
                            <span class="form__dept-title" data-dept="11" data-deptName="Pediatric Cardiology">Pediatric Cardiology</span>
                        </div>
                        <div id="dept_11" class="form__card">
                            <div class="form__img-container"> 
                                <img class="form__dept-img" src="./../imgs/dummyimg.png" alt="" srcset="">
                            </div>
                            <span class="form__dept-title" data-dept="12" data-deptName="Pediatric Clearance">Pediatric Clearance</span>
                        </div>
                        <div id="dept_12" class="form__card">
                            <div class="form__img-container"> 
                                <img class="form__dept-img" src="./../imgs/dummyimg.png" alt="" srcset="">
                            </div>
                            <span class="form__dept-title" data-dept="13" data-deptName="Pediatric General">Pediatric General</span>
                        </div>
                        <div id="dept_13" class="form__card">
                            <div class="form__img-container"> 
                                <img class="form__dept-img" src="./../imgs/psychiatry_new.png" alt="" srcset="">
                            </div>
                            <span class="form__dept-title" data-dept="14" data-deptName="Psychiatry New">Psychiatry New</span>
                        </div>
                        <div id="dept_14" class="form__card">
                            <div class="form__img-container"> 
                                <img class="form__dept-img" src="./../imgs/psychiatry_old.png" alt="" srcset="">
                            </div>
                            <span class="form__dept-title" data-dept="15" data-deptName="Psychiatry Old">Psychiatry Old</span></div>
                        <div id="dept_15" class="form__card">
                            <div class="form__img-container"> 
                                <img class="form__dept-img" src="./../imgs/surgery.png" alt="" srcset="">
                            </div>
                            <span class="form__dept-title" data-dept="16" data-deptName="Surgery">Surgery</span> <!--ENT -->
                        </div> 
                        <div id="dept_16" class="form__card">
                            <div class="form__img-container"> 
                                <img class="form__dept-img" src="./../imgs/surgery ros.png" alt="" srcset="">
                            </div>
                            <span class="form__dept-title" data-dept="17" data-deptName="Surgery Review of Systems">Surgery ROS</span>
                        </div> 
                    </div>
                    <div class="form-part second" style="display: none;">
                        ...
                        <div class="field-container caseNo-container">
                            ...
                            <input type="text" name="caseNo" id="caseNo" value="" oninput="filterCaseNo(this.id)">
                        </div>
